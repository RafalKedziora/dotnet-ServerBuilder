...
using MinecraftServerCreator.Models;
using MinecraftServerCreator.Services;
using System.IO;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddScoped<IApiOperator<Domain.Fabric.ProjectVersions>, FabricApiConsumer>();

                // Views and ViewModels
                services.AddScoped<Views.Pages.CreateServerPage>();
                services.AddScoped<ViewModels.CreateServerViewModel>();
